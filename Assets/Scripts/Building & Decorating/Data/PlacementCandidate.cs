...
/// Passed to FurnitureSpawner to know where and how to instantiate furniture.
/// </summary>
public readonly struct PlacementCandidate
{
    ...
    /// Stored so FurnitureSpawner can later check occupancy without re-projecting world positions.
    /// </summary>
